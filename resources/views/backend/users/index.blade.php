            ...
            @foreach($users as $user)   
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('admin.users.status',$user->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Toggle Status" data-placement="bottom"><i class="fas fa-toggle-on"></i></a>
