								...
								<div class="right">
									<ul>
										...
										<li class="order_subtotal" data-price="{{$subtotal}}">
											Original Price<span>₱{{number_format($subtotal,2)}}</span>
										</li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{$discount}}" style="color: #28a745;">
											Discount Applied<span>-₱{{number_format($discount,2)}}</span>
										</li>
										@endif
										
										<li class="last" id="order_total_price" style="font-weight: bold; font-size: 1.2em;">
											Final Total<span>₱{{number_format($final_amount,2)}}</span>
										</li>
									</ul>
									<div class="button5">
