<header class="header shop">
                                    ...
                                    <ul class="shopping-list">
                                        <?php $__currentLoopData = Helper::getAllProductFromWishlist(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                ...
                                                $after_discount=($data->product['price']-($data->product['price']*$data->product['discount'])/100);
                                            ?>
                                            <li>
                                                ...
                                                <p class="quantity"><?php echo e($data->quantity); ?> x - <span class="amount">₱<?php echo e(number_format($after_discount,2)); ?></span></p>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <div class="bottom">
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-feature-tree\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>