      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="https://github.com/intronerd12" target="_blank">Axel Jilian Bumatay</a> <?php echo e(date('Y')); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-feature-tree\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>