<?php $__env->startSection('title','Perfume Store || DASHBOARD'); ?>
...
<div class="container-fluid">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(\App\Models\Order::monthlyIncome()); ?></div>
              </div>
              <div class="col-auto">
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">₱<?php echo e(\App\Models\Order::yearlyIncome()); ?></div>
              </div>
              <div class="col-auto">
    ...
    <div class="row">
      <!-- Remove Product Sales Distribution section -->
    </div>
    <div class="row">
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    const url = "<?php echo e(route('product.order.income')); ?>?timestamp=" + new Date().getTime();
...
<script>
$(function() {
    // Initialize daterangepicker with preset ranges
    $('input[name="daterange"]').daterangepicker({
        ...
        // Update earnings chart when date range changes
        updateEarningsChart(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'));
    });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-main\resources\views/backend/index.blade.php ENDPATH**/ ?>