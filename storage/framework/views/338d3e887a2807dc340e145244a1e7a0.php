        ...
        <div class="form-group">
          ...
          <div class="input-group">
              <span class="input-group-btn">
                  <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary" data-type="category">
...
<script>
    $('#lfm').filemanager('image', {type: 'category'});
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-main\resources\views/backend/category/create.blade.php ENDPATH**/ ?>