											...
											<div class="product-slider">
												<div class="main-img-slider">
													...
													<?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<div class="item">
															<img src="<?php echo e(trim($photo)); ?>" alt="Product Image <?php echo e($key+1); ?>" class="img-fluid">
														</div>
												...
												<div class="slider-nav-wrapper">
													<div class="slider-nav">
														<?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<div class="item">
																<img src="<?php echo e(trim($photo)); ?>" alt="Thumbnail <?php echo e($key+1); ?>">
															</div>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													</div>
												</div>
...
<?php $__env->startPush('styles'); ?>
	<style>
		...
		.main-img-slider { margin-bottom: 10px; }
		.main-img-slider .item { padding: 0 1px; }
		.main-img-slider .item img { width: 100%; }
		.slider-nav .item { padding: 5px; cursor: pointer; }
		.slider-nav .item img { max-width: 80px; }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-main\resources\views/frontend/pages/product_detail.blade.php ENDPATH**/ ?>