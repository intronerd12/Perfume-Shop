							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										?>
										<li class="order_subtotal" data-price="<?php echo e($subtotal); ?>">
											Original Price<span>₱<?php echo e(number_format($subtotal,2)); ?></span>
										</li>

										<?php if(session()->has('coupon')): ?>
										<li class="coupon_price" data-price="<?php echo e($discount); ?>" style="color: #28a745;">
											Discount Applied<span>-₱<?php echo e(number_format($discount,2)); ?></span>
										</li>
										<?php endif; ?>
										
										<li class="last" id="order_total_price" style="font-weight: bold; font-size: 1.2em;">
											Final Total<span>₱<?php echo e(number_format($final_amount,2)); ?></span>
										</li>
									</ul>
									<div class="button5">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-main\resources\views/frontend/pages/cart.blade.php ENDPATH**/ ?>