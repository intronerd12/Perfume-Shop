<!-- Start Footer Area -->
				...
				<div class="inner">
					<div class="row">
						<div class="col-lg-6 col-12">
							<div class="left">
								<p>Copyright © <?php echo e(date('Y')); ?> <a href="https://github.com/intronerd12" target="_blank">Axel Jilian Bumatay</a>  -  All Rights Reserved.</p>
							</div>
						</div>
						<div class="col-lg-6 col-12">
							<div class="right">
	...
	<script>
	  ...
	  </script><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-feature-tree\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>