...
<div class="card">
    ...
    <form method="post" action="<?php echo e(route('settings.update')); ?>">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="quote" name="short_des" placeholder="Enter short description"><?php echo e(old('short_des', $data->short_des)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description" placeholder="Enter description"><?php echo e(old('description', $data->description)); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-main\resources\views/backend/setting.blade.php ENDPATH**/ ?>