          ...
          <div id="photos-container">
            <div class="input-group mb-3">
                <span class="input-group-btn">
                    ...
                    <i class="fas fa-image"></i> Choose Photos
                    </a>
                </span>
                <input id="thumbnail" class="form-control" type="text" name="photo" value="<?php echo e($product->photo); ?>">
            </div>
            <div id="holder" style="margin-top:15px;" class="d-flex flex-wrap">
                <?php 
                    $photos = explode(',', $product->photo);
                ?>
                <?php $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($photo): ?>
                        <img src="<?php echo e(trim($photo)); ?>" style="height:80px;width:80px;object-fit:cover;margin:5px;">
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          </div>
...
<script>
    $('#lfm').filemanager('image', {type: 'image', multiple: true});
        ...
        $('#thumbnail').on('change', function() {
            ...
            if(input) {
                ...
                images.forEach(function(image) {
                    if(image.trim()) {
                        holder.append(`<img src="${image.trim()}" style="height:80px;width:80px;object-fit:cover;margin:5px;">`);
                    }
                });
            }
        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp_bumatay\htdocs\Perfume-Shop-main\resources\views/backend/product/edit.blade.php ENDPATH**/ ?>